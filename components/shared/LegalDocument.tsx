      ...
      <div className="container-page section-y">
        <div className="grid gap-12 lg:grid-cols-[15rem_1fr] lg:gap-16">
          <nav aria-label="On this page" className="lg:sticky lg:top-28 lg:self-start">
            <p className="eyebrow text-brass-deep">On this page</p>
            <ol className="mt-5 space-y-2.5 border-l border-border pl-4">
              {sections.map((section, index) => (
                <li key={section.id}>
                  ...
                  >
                    <span className="mr-2 font-mono text-[0.7rem] text-brass-deep tnum">
          ...
          <div className="max-w-[68ch]">
            {sections.map((section, index) => (
              ...
              >
                <div id={section.id}>
                  <p className="font-mono text-[0.7rem] tracking-[0.14em] text-brass-deep uppercase tnum">
                    ...
                    <ul className="mt-5 space-y-2.5">
                      {section.list.map((item) => (
                        <li key={item} className="flex gap-3">
                          <span
                            aria-hidden="true"
                            className="mt-[0.62rem] size-1 shrink-0 bg-brass"
                          />
